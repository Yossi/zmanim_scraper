...
[^1]: Follows the pretty opinionated rules set forth by my local Chabad house. If you want the rules different you can change them, but they are not organized for ease of doing this. It's probably not hard, but you will need to skim all the code.
